var CreatePostProcessRefractionTestScene = function (engine) {
    ...
    // Post-process
    var postProcess = new BABYLON.RefractionPostProcess("Refraction", "/dlintec/static/dit/Babylon/samples/Scenes/Customs/refMap.jpg", new BABYLON.Color3(1.0, 1.0, 1.0), 0.5, 0.5, 1.0, camera);
