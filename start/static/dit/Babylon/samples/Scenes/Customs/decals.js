var CreateDecalsTestScene = function (engine) {
	...
	BABYLON.SceneLoader.ImportMesh("Shcroendiger'scat", "/dlintec/static/dit/Babylon/samples/Scenes/Assets/", "SSAOcat.babylon", scene, function (newMeshes) {
		var cat = newMeshes[0];
		...
		decalMaterial.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Assets/impact.png", scene);
