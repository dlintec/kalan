var CreateFresnelTestScene = function (engine) {
    ...
    // Sphere1 material
    material.reflectionTexture = new BABYLON.CubeTexture("/dlintec/static/dit/Babylon/samples/Scenes/Customs/skybox/TropicalSunnyDay", scene);
    ...
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("/dlintec/static/dit/Babylon/samples/Scenes/Customs/skybox/TropicalSunnyDay", scene);
    ...
    var flare00 = new BABYLON.LensFlare(0.2, 0, new BABYLON.Color3(1, 1, 1), "/dlintec/static/dit/Babylon/samples/Scenes/Assets/flare.png", lensFlareSystem);
    var flare01 = new BABYLON.LensFlare(0.5, 0.2, new BABYLON.Color3(0.5, 0.5, 1), "/dlintec/static/dit/Babylon/samples/Scenes/Assets/flare.png", lensFlareSystem);
    var flare02 = new BABYLON.LensFlare(0.2, 1.0, new BABYLON.Color3(1, 1, 1), "/dlintec/static/dit/Babylon/samples/Scenes/Assets/flare.png", lensFlareSystem);
    var flare03 = new BABYLON.LensFlare(0.4, 0.4, new BABYLON.Color3(1, 0.5, 1), "/dlintec/static/dit/Babylon/samples/Scenes/Assets/flare.png", lensFlareSystem);
    var flare04 = new BABYLON.LensFlare(0.1, 0.6, new BABYLON.Color3(1, 1, 1), "/dlintec/static/dit/Babylon/samples/Scenes/Assets/flare.png", lensFlareSystem);
    var flare05 = new BABYLON.LensFlare(0.3, 0.8, new BABYLON.Color3(1, 1, 1), "/dlintec/static/dit/Babylon/samples/Scenes/Assets/flare.png", lensFlareSystem);
