var CreateProceduralTextureTestScene = function (engine) {
    ...
    var customProcText = new BABYLON.CustomProceduralTexture("customtext", "/dlintec/static/dit/Babylon/samples/Scenes/Customs/customProceduralTextures/land", 1024, scene);
