var CreateVolumetricLightScatteringScene = function (engine) {
	...
	BABYLON.SceneLoader.ImportMesh("", "/dlintec/static/dit/Babylon/samples/Scenes/Assets/", "skull.babylon", scene, function (newMeshes) {
	...
	// position and scale
	godrays.mesh.material.diffuseTexture = new BABYLON.Texture('/scenes/assets/sun.png', scene, true, false, BABYLON.Texture.BILINEAR_SAMPLINGMODE);
