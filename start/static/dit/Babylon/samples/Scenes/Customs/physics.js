var CreatePhysicsScene = function (engine) {
    ...
    materialAmiga.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Assets/amiga.jpg", scene);
    materialAmiga.emissiveColor = new BABYLON.Color3(0.5, 0.5, 0.5);
    materialAmiga.diffuseTexture.uScale = 5;
    materialAmiga.diffuseTexture.vScale = 5;

    var materialAmiga2 = new BABYLON.StandardMaterial("amiga", scene);
    materialAmiga2.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Assets/mosaic.jpg", scene);
    ...
    materialWood.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Assets/wood.jpg", scene);
