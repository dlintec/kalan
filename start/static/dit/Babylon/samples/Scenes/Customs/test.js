var CreateTestScene = function (engine) {
    ...
    material.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Assets/Tree.png", scene);
    material.diffuseTexture.hasAlpha = true;
    material.backFaceCulling = false;
    material2.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Assets/kosh.jpg", scene);
    material2.alpha = 0.5;
    material2.backFaceCulling = false;
    material3.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Assets/kosh.jpg", scene);
    ...
    particleSystem.particleTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Assets/flare.png", scene);
    ...
    // Sprites
    var spriteManager = new BABYLON.SpriteManager("MonsterA", "/dlintec/static/dit/Babylon/samples/Scenes/Assets/Player.png", 500, 64, scene);
    ...
    // Backgrounds
    var background0 = new BABYLON.Layer("back0", "/dlintec/static/dit/Babylon/samples/Scenes/Assets/Layer0_0.png", scene);
    var background1 = new BABYLON.Layer("back1", "/dlintec/static/dit/Babylon/samples/Scenes/Assets/Layer1_0.png", scene);
    var foreground = new BABYLON.Layer("back0", "/dlintec/static/dit/Babylon/samples/Scenes/Assets/Layer2_0.png", scene, true, new BABYLON.Color4(1, 0, 0, 1));
