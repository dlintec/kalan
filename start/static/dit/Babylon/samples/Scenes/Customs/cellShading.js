var CreateCellShadingScene = function (engine) {
    ...
    var cellShadingMaterial = new BABYLON.ShaderMaterial("cellShading", scene, "/dlintec/static/dit/Babylon/samples/Scenes/Customs/shaders/cellShading",
    {
        uniforms: ["world", "viewProjection"],
        samplers: ["textureSampler"]
    });
    cellShadingMaterial.setTexture("textureSampler", new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Customs/Ground.jpg", scene))
