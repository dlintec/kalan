var CreatePostProcessBloomTestScene = function (engine) {
    ...
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("/dlintec/static/dit/Babylon/samples/Scenes/Customs/skybox/snow", scene);
    ...
    var postProcess1 = new BABYLON.PostProcess("Down sample", "/dlintec/static/dit/Babylon/samples/Scenes/Customs/postprocesses/downsample", ["screenSize", "highlightThreshold"], null, 0.25, camera, BABYLON.Texture.BILINEAR_SAMPLINGMODE);
    ...
    var postProcess4 = new BABYLON.PostProcess("Final compose", "/dlintec/static/dit/Babylon/samples/Scenes/Customs/postprocesses/compose", ["sceneIntensity", "glowIntensity", "highlightIntensity"], ["sceneSampler"], 1, camera);
