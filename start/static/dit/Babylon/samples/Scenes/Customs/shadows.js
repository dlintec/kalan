var CreateShadowsTestScene = function (engine) {
    ...
    skyboxMaterial.reflectionTexture = new BABYLON.CubeTexture("/dlintec/static/dit/Babylon/samples/Scenes/Customs/skybox/night", scene);
    ...
    if (engine.getCaps().s3tc) {
        groundMaterial.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Customs/grass.dds", scene);
    } else {
        groundMaterial.diffuseTexture = new BABYLON.Texture("/dlintec/static/dit/Babylon/samples/Scenes/Customs/grass.jpg", scene);
    }
