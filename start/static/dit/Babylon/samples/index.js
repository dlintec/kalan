...
var onload = function () {
    ...
    var tests = [
        ...
        { title: "ASSETS MANAGER", url: "/dlintec/static/dit/Babylon/samples/Scenes/Assets/index.html", screenshot: "assets.jpg", size: "1 MB", anchor: "ASSETS" },
        ...
        { title: "VERTEXDATA", url: "/dlintec/static/dit/Babylon/samples/Scenes/Clouds/index.html", screenshot: "clouds.jpg", size: "1 MB", anchor: "CLOUDS" },
    ...
    var itemClick = function (demo) {
        return function () {
            var sceneLocation = "/dlintec/static/dit/Babylon/samples/Scenes/";
            // Check support
            if (!BABYLON.Engine.isSupported()) {
                ...
                if (window.location.hostname.indexOf("localhost") === -1) {
                    if (demo.doNotUseCDN) {
                        sceneLocation = "/dlintec/static/dit/Babylon/samples/Scenes/";
                    }
                    else {
                        sceneLocation = "/dlintec/static/dit/Babylon/samples/Scenes/";
                    }
                }
				if (demo.sceneLocation) {
					sceneLocation=demo.sceneLocation;
				}
    ...
    var createItem = function (item, root) {
        ...
        if (item.big) {
            ...
            newImg.id = "newImg";
            newImg.src = "/dlintec/static/dit/Babylon/samples/Assets/SpotLast.png";
       ...
       //img.src = "Screenshots/" + item.screenshot;
        img.src = "/dlintec/static/images/logo.png";
